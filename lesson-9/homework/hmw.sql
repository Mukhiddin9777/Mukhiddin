...
Select CONCAT_WS(' ', FirstName, LastName) As Fullname,  OrderID from Orders as Ord
...
Select Distinct Ord.OrderID from Payments as Pay
join Orders as Ord
on Pay.OrderID= Ord.OrderID

--Using Orders, Products table Show orders where product price is more than 100.
Select ProductName, Price from Products as Pr
join Orders as Ord
on Pr.ProductID=Ord.ProductID
where Price>100
...
Select CONCAT_WS(' ', FirstName, LastName) Fullname,  ProductID from Customers as Cus
join Sales as Sal
...
Select Name, CourseName from Courses as Co
join Enrollments as En
...
Select Employee.Name as Emp_Name, Manager.Name as Man_Name from Employees as Employee
join Employees as Manager
on Employee.ManagerID=Manager.EmployeeID
where Employee.Salary>Manager.Salary

--Using Products, Categories table Show products where category is either 'Electronics' or 'Furniture'.
Select ProductName from Products as Pr
...
Select Sal.* from Customers as Cus
join Sales as Sal
on Cus.CustomerID=Sal.CustomerID
where Country='USA'
...
Select Ord.OrderID, CONCAT_WS (' ', FirstName, LastName) as Fullname, TotalAmount from Orders as Ord
join Customers as Cus
on Ord.CustomerID=Cus.CustomerID
...
Select Employee.Name as EmpName, Manager.Name as ManagName from Employees as Employee
join Employees as Manager
on Employee.ManagerID = Manager.EmployeeID
where Employee.Salary>=Manager.Salary
...
Select CONCAT_WS(' ', FirstName, LastName) [Full name] from Customers as Cu
Left join Orders as Ord
on Cu.CustomerID= Ord.CustomerID
Left join Payments as Pay
on Pay.OrderID=Ord.OrderID
Where Ord.TotalAmount is not null and Pay.Amount is null
Order by FirstName
